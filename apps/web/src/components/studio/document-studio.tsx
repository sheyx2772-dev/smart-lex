...
const cTail = (payer: string, a: string, b: string) =>
  `<h3>4. TOMONLARNING JAVOBGARLIGI</h3><p>4.1. Tomonlar shartnoma majburiyatlarini bajarmaganlik yoki lozim darajada bajarmaganlik uchun O'zbekiston Respublikasi Fuqarolik kodeksi hamda «Xo'jalik yurituvchi subyektlar faoliyatining shartnomaviy-huquqiy bazasi to'g'risida»gi Qonunning 24-moddasiga muvofiq javobgar bo'ladilar.</p><p>4.2. To'lov (yoki asosiy majburiyat) muddati buzilganda, ${payer} har bir kechiktirilgan kalendar kun uchun [Foiz]% miqdorida penya to'laydi; penyaning umumiy miqdori tegishli summaning [Penya chegarasi]% idan oshmaydi.</p><p>4.3. Penya to'lash Tomonlarni asosiy majburiyatni bajarishdan ozod etmaydi. Aybdor Tomon Fuqarolik kodeksining 324-moddasiga muvofiq yetkazilgan real zararni ham qoplaydi.</p>` +
  `<h3>5. FORS-MAJOR (YENGIB BO'LMAS KUCH)</h3><p>5.1. Yengib bo'lmas kuch holatlari (tabiiy ofat, urush, favqulodda vaziyat, vakolatli davlat organlarining qarorlari va shu kabilar) yuzaga kelganda, Tomonlar majburiyatlarni bajarmaganlik uchun javobgarlikdan ozod etiladi.</p><p>5.2. Bunday holat yuzaga kelgan Tomon boshqa Tomonni [Muddat] ichida yozma xabardor qiladi. Holat tugagach, majburiyatlarni bajarish tiklanadi.</p>` +
  `<h3>6. NIZOLARNI HAL QILISH</h3><p>6.1. Nizolar avval muzokara va sudgacha (pretenziya) tartibida hal etiladi; pretenziyaga javob berish muddati — 30 (o'ttiz) kalendar kun.</p><p>6.2. Kelishuvga erishilmasa, nizo O'zbekiston Respublikasi Iqtisodiy protsessual kodeksiga muvofiq javobgarning joylashgan yeri bo'yicha iqtisodiy sud tomonidan ko'rib chiqiladi.</p>` +
  `<h3>7. SHARTNOMA MUDDATI, O'ZGARTIRISH VA BEKOR QILISH</h3><p>7.1. Shartnoma imzolangan kundan kuchga kiradi va Tomonlar o'z majburiyatlarini to'liq bajargunga qadar amal qiladi.</p><p>7.2. Shartnomaga o'zgartirish va qo'shimchalar Tomonlar imzolagan yozma qo'shimcha kelishuv bilan kiritiladi. Shartnoma Fuqarolik kodeksining 382 va 384-moddalarida nazarda tutilgan asoslar va tartibda o'zgartirilishi yoki bekor qilinishi mumkin.</p>` +
  `<h3>8. YAKUNIY QOIDALAR</h3><p>8.1. Shartnomada tartibga solinmagan masalalar O'zbekiston Respublikasi amaldagi qonunchiligiga muvofiq hal etiladi.</p><p>8.2. Shartnoma teng yuridik kuchga ega ikki nusxada, har bir Tomon uchun bittadan tuzildi.</p>` +
  cReq(a, b);
...
// ── Sudga tayyor undiruv hujjatlari (real yuridik firma hujjatlari tuzilmasi) ──
// Da'vogar/Javobgar to'liq rekvizit, Da'vo bahosi ajratib, aniq modda raqamlari
// (FK 236/237/324/327, XSHB 24/25, IPK 93/94/149-151), penya hisob-kitobi,
// da'voni ta'minlash (xatlash), raqamli ilova ro'yxati.
const davoDoc = () =>
  `<h2 style="text-align:center">DA'VO ARIZASI</h2>` +
  `<p style="text-align:center">(Qarzdorlikni va penyani undirish to'g'risida)</p>` +
  `<p style="text-align:right">[Sana]</p>` +
  `<p style="text-align:right"><strong>[Shahar] tumanlararo iqtisodiy sudiga</strong></p>` +
  `<p><strong>Da'vogar:</strong> «[Kreditor nomi]»<br>Manzil: [Kreditor manzili]<br>STIR: [Kreditor STIR]<br>Bank: [Kreditor bank], H/r: [Kreditor h/r], MFO: [Kreditor MFO]<br>Tel: [Kreditor telefoni]</p>` +
  `<p><strong>Javobgar:</strong> «[Qarzdor nomi]»<br>Manzil: [Qarzdor manzili]<br>STIR: [Qarzdor STIR]<br>Bank: [Qarzdor bank], H/r: [Qarzdor h/r], MFO: [Qarzdor MFO]<br>Tel: [Qarzdor telefoni]</p>` +
  `<p><strong>Da'vo bahosi:</strong> Jami: <strong>[Jami summa]</strong> ([Asosiy qarz] — asosiy qarz, [Penya] — penya, [Davlat boji] — davlat boji, [Pochta xarajati] — pochta xarajatlari)</p>` +
  `<h3>1. Ishning holati</h3><p>1.1. Da'vogar «[Kreditor nomi]» va Javobgar «[Qarzdor nomi]» o'rtasida [Shartnoma sanasi] da № [Shartnoma raqami] shartnoma (bundan buyon — «Shartnoma») tuzilgan. Shartnomaga ko'ra Da'vogar tovar (xizmat) yetkazib berish, Javobgar esa uni qabul qilib, haqini belgilangan muddatda to'lash majburiyatini olgan.</p><p>1.2. Da'vogar tomonidan Javobgarga № [Faktura raqami] hisob-faktura asosida tovar (xizmat) yetkazib berilgan; bu tegishli hujjatlar bilan tasdiqlanadi.</p>` +
  `<h3>2. Nizoning kelib chiqishi</h3><p>2.1. Javobgar Shartnomada belgilangan muddatda to'lov majburiyatini bajarmagan. № [Akt raqami] o'zaro hisob-kitob akti (akt-sverka) ma'lumotlariga ko'ra Javobgarning asosiy qarzdorligi [Asosiy qarz]ni tashkil etadi. Akt ikki tomon tomonidan imzolangan va Javobgar qarzni tan olgan.</p>` +
  `<h3>3. Da'voning qonuniy asoslari</h3><p>3.1. O'zbekiston Respublikasi Fuqarolik kodeksining 236-moddasiga ko'ra majburiyatlar shartnoma shartlariga va qonunchilik talablariga muvofiq lozim darajada bajarilishi shart. Kodeksning 237-moddasiga ko'ra majburiyatni bajarishdan bir tomonlama bosh tortishga yo'l qo'yilmaydi.</p><p>3.2. Fuqarolik kodeksining 327-moddasiga asosan pul majburiyatini bajarmaganlik uchun javobgarlik, 324-moddasiga asosan qarzdorning zararni to'lash majburiyati yuzaga keladi.</p><p>3.3. «Xo'jalik yurituvchi subyektlar faoliyatining shartnomaviy-huquqiy bazasi to'g'risida»gi Qonunning 24-moddasiga asosan, taraf shartnoma majburiyatlarini bajarmaganda yetkazilgan zararni to'laydi; shartnoma amal qilish muddatining tugashi taraflarni javobgarlikdan ozod etmaydi.</p>` +
  `<h3>4. Penya hisob-kitobi</h3><p>4.1. Shartnomaning [Penya bandi]-bandiga ko'ra, to'lov kechiktirilganda Javobgar har bir kechiktirilgan kun uchun [Penya foizi]% miqdorida penya to'laydi. [Boshlanish sanasi]dan [Tugash sanasi]gacha bo'lgan davr uchun hisoblangan penya summasi [Penya]ni tashkil etadi.</p>` +
  `<h3>5. Nizoni sudgacha hal qilish uchun ko'rilgan choralar</h3><p>5.1. Da'vogar Javobgarga [Talabnoma sanasi] da № [Chiquvchi raqam] talabnoma yuborgan, biroq Javobgar talabnomada ko'rsatilgan muddatda majburiyatini bajarmagan.</p>` +
  `<h3>6. Da'voni ta'minlash choralari</h3><p>6.1. O'zbekiston Respublikasi Iqtisodiy protsessual kodeksining 93 va 94-moddalariga asosan, sudning hal qiluv qarori qonuniy kuchga kirgunga qadar Javobgarning hisob raqamlaridagi [Jami summa] miqdoridagi pul mablag'larini xatlab qo'yish orqali huquqimizni ta'minlash so'raladi.</p><p>Yuqoridagilarga asoslanib, O'zbekiston Respublikasi Iqtisodiy protsessual kodeksining 3, 149-151-moddalariga muvofiq,</p>` +
  `<h3 style="text-align:center">SO'RAYMAN:</h3><p>1) Javobgar «[Qarzdor nomi]»dan Da'vogar «[Kreditor nomi]» foydasiga [Asosiy qarz] asosiy qarzni, [Penya] penyani, [Davlat boji] davlat bojini, [Pochta xarajati] pochta xarajatlarini, jami — <strong>[Jami summa]</strong>ni undirib berishni;</p><p>2) Da'vo arizasi ko'rib chiqilib, sudning hal qiluv qarori qonuniy kuchga kirgunga qadar Javobgarning hisob raqamidagi [Jami summa] miqdoridagi pul mablag'larini xatlab qo'yishni.</p>` +
  `<p><strong>Ilova qilinadigan hujjatlar ro'yxati:</strong></p><p>1. Davlat boji va pochta xarajatlari to'langanligi to'g'risidagi hujjat;<br>2. № [Shartnoma raqami] shartnoma nusxasi;<br>3. № [Faktura raqami] hisob-faktura nusxasi;<br>4. № [Akt raqami] o'zaro hisob-kitob akti nusxasi;<br>5. № [Chiquvchi raqam] talabnoma nusxasi va yuborilgani tasdig'i;<br>6. Da'vogarning davlat ro'yxatidan o'tganligi to'g'risidagi guvohnoma nusxasi;<br>7. Kichik tadbirkorlik subyekti ekanligini tasdiqlovchi hujjat nusxasi.</p>` +
  `<p>«[Kreditor nomi]»<br>Direktor [Kreditor direktori] _________________&nbsp;&nbsp; M.O'.</p>`;
const talabnomaDoc = () =>
  `<h2 style="text-align:center">TALABNOMA</h2>` +
  `<p style="text-align:right">Reg. № [Chiquvchi raqam] · [Sana]</p>` +
  `<p><strong>Kimga:</strong> «[Qarzdor nomi]» rahbariga<br>Manzil: [Qarzdor manzili]</p>` +
  `<p><strong>Kimdan:</strong> «[Kreditor nomi]»<br>Manzil: [Kreditor manzili] · STIR: [Kreditor STIR]</p>` +
  `<p>Ushbu talabnoma «[Kreditor nomi]» (bundan buyon — «Yetkazib beruvchi») va «[Qarzdor nomi]» (bundan buyon — «Xaridor») o'rtasida [Shartnoma sanasi] da tuzilgan № [Shartnoma raqami] shartnoma bo'yicha yuzaga kelgan majburiyatni bajarmaslik yuzasidan taqdim etiladi.</p>` +
  `<h3>1. Holat</h3><p>Shartnomaga asosan Yetkazib beruvchi Xaridorga umumiy qiymati [Jami summa] bo'lgan tovar (xizmat) yetkazib bergan; № [Faktura raqami] hisob-faktura yuborilgan. Xaridor Shartnoma bo'yicha to'lov majburiyatini belgilangan muddatda bajarmagan.</p>` +
  `<h3>2. Talab va huquqiy asos</h3><p>O'zbekiston Respublikasi Fuqarolik kodeksining 236 va 327-moddalariga hamda «Xo'jalik yurituvchi subyektlar faoliyatining shartnomaviy-huquqiy bazasi to'g'risida»gi Qonunning 24 va 25-moddalariga muvofiq, shartnoma majburiyatlarini bajarmaganlik uchun javobgarlik hamda to'lov muddatini kechiktirganlik uchun jarima (penya) belgilangan.</p><p>Yetkazib beruvchi sifatida Xaridordan quyidagi summalarni to'lashni talab qilamiz:<br>Asosiy qarz: <strong>[Asosiy qarz]</strong><br>Penya: har bir kechiktirilgan kun uchun [Penya foizi]% miqdorida.</p><p>To'lov rekvizitlari — Oluvchi: «[Kreditor nomi]», H/r: [Kreditor h/r], Bank MFO: [Kreditor MFO], STIR: [Kreditor STIR].</p>` +
...
const CATALOG: Template[] = [
  ...
  },
  {
    ...
    html: `<h2 style="text-align:center">PRETENZIYA</h2><p style="text-align:right">[Sana] · № [Chiquvchi raqam]</p><p><strong>Kimga:</strong> «[Qarzdor nomi]» (STIR: [Qarzdor STIR])<br><strong>Manzil:</strong> [Qarzdor manzili]</p><p>«[Kreditor nomi]» (STIR: [Kreditor STIR]) № [Shartnoma raqami] shartnoma va № [Faktura raqami] hisob-faktura bo'yicha yuzaga kelgan qarzdorlik yuzasidan ushbu pretenziyani (sudgacha talab) yo'llaydi.</p><h3>1. Holat</h3><p>«[Kreditor nomi]» Shartnoma bo'yicha o'z majburiyatlarini to'liq bajardi. Javob beruvchi tomon to'lovni belgilangan muddatda amalga oshirmadi.</p><h3>2. Qarzdorlik</h3><p>Asosiy qarz: <strong>[Asosiy qarz]</strong><br>Penya ([Kechikish kunlari] kun): <strong>[Penya]</strong><br>Jami: <strong>[Jami summa]</strong></p><h3>3. Huquqiy asos</h3><p>O'zbekiston Respublikasi Fuqarolik kodeksining 236-moddasiga ko'ra majburiyatlar lozim darajada va o'z vaqtida bajarilishi shart, 237-moddaga ko'ra ularni bajarishdan bir tomonlama bosh tortishga yo'l qo'yilmaydi; 327-moddaga asosan pul majburiyatini bajarmaganlik uchun javobgarlik yuzaga keladi. «Xo'jalik yurituvchi subyektlar faoliyatining shartnomaviy-huquqiy bazasi to'g'risida»gi Qonunning 24-moddasiga ko'ra, taraf shartnoma majburiyatlarini bajarmaganda yetkazilgan zararni to'laydi.</p><h3>4. Talab</h3><p>Iqtisodiy protsessual kodeksning sudgacha (pretenziya) tartibi talablariga muvofiq, ushbu pretenziya olingan kundan boshlab <strong>[Muddat] kalendar kun</strong> ichida yuqoridagi summani quyidagi rekvizitlarga to'lashingizni talab qilamiz:<br>H/r: [Kreditor h/r] · Bank: [Kreditor bank] · MFO: [Kreditor MFO].</p><p>Talab bajarilmasa, «[Kreditor nomi]» qarzni, penyani, davlat bojini va barcha sud xarajatlarini undirish uchun iqtisodiy sudga da'vo arizasi bilan murojaat qiladi.</p><p><strong>Ilova:</strong> shartnoma va hisob-fakturalar nusxasi; akt-sverka.</p><p>Hurmat bilan,<br>«[Kreditor nomi]»<br>[Kreditor direktori] _________________&nbsp;&nbsp; M.O'.</p>`,
  },
  {
    key: "lawsuit",
    cat: "collection",
  ...
  },
  {
    ...
    html: contractDoc({
      ...
      payer: "Ijarachi",
      body:
        `<h3>1. SHARTNOMA PREDMETI</h3><p>1.1. O'zbekiston Respublikasi Fuqarolik kodeksining 535-moddasiga (mulk ijarasi shartnomasi) muvofiq, Ijaraga beruvchi quyidagi mol-mulkni Ijarachiga vaqtinchalik egalik qilish va foydalanishga beradi: [Ijara obyekti] (manzil/tavsif: [Obyekt manzili]).</p><p>1.2. Mol-mulk ijaraga beruvchining mulki bo'lib, uchinchi shaxslar huquqidan xoli.</p>` +
  ...
  },
  {
    ...
    html: contractDoc({
      ...
      payer: "Buyurtmachi",
      body:
        `<h3>1. SHARTNOMA PREDMETI</h3><p>1.1. O'zbekiston Respublikasi Fuqarolik kodeksining 631-moddasiga (pudrat shartnomasi) muvofiq, Pudratchi Buyurtmachining topshirig'iga binoan [Ish nomi] ishlarini o'z kuchi va vositalari bilan bajaradi, Buyurtmachi esa natijani qabul qilib haqini to'laydi.</p><p>1.2. Ishlar hajmi, tarkibi va talablari smeta hamda texnik topshiriq (ilova)da belgilanadi.</p>` +
  ...
  },
  {
    ...
    html: contractDoc({
      ...
      payer: "Qarz oluvchi",
      body:
        `<h3>1. SHARTNOMA PREDMETI</h3><p>1.1. O'zbekiston Respublikasi Fuqarolik kodeksining 732-moddasiga (qarz shartnomasi) muvofiq, Qarz beruvchi Qarz oluvchiga <strong>[Jami summa]</strong> miqdorida pul mablag'ini qarzga beradi, Qarz oluvchi esa uni belgilangan muddatda qaytarish majburiyatini oladi (Fuqarolik kodeksining 735-moddasi).</p><p>1.2. Qarz mablag'i o'tkazilgani to'lov hujjati (yoki tilxat) bilan tasdiqlanadi.</p>` +
        `<h3>2. FOIZLAR</h3><p>2.1. Fuqarolik kodeksining 734-moddasiga muvofiq, qarzdan foydalanganlik uchun yillik [Foiz]% ustama hisoblanadi (agar Tomonlar foizsiz deb kelishmagan bo'lsa).</p>` +
  ...
  },
  {
    ...
    html: `<h2 style="text-align:center">SHARTNOMANI BEKOR QILISH TO'G'RISIDA KELISHUV</h2><p style="text-align:center">[Shahar] sh.&nbsp;&nbsp;&nbsp;[Sana]</p><p>«[Kreditor nomi]» (STIR: [Kreditor STIR]) va «[Qarzdor nomi]» (STIR: [Qarzdor STIR]), birgalikda «Tomonlar» deb ataluvchi, o'rtasida tuzilgan № [Shartnoma raqami] shartnomaga (bundan buyon — «Shartnoma») nisbatan quyidagilar to'g'risida kelishdilar:</p><h3>1. BEKOR QILISH</h3><p>1.1. Tomonlar O'zbekiston Respublikasi Fuqarolik kodeksining 382 va 384-moddalariga muvofiq № [Shartnoma raqami] Shartnomani [Sana]dan boshlab o'zaro kelishuv asosida bekor qiladilar. Ushbu sanadan e'tiboran Shartnoma bo'yicha kelgusi majburiyatlar to'xtatiladi (Fuqarolik kodeksining 385-moddasi).</p><h3>2. O'ZARO HISOB-KITOB</h3><p>2.1. Bekor qilish sanasiga o'zaro moliyaviy holat: [Jami summa]. Hisob-kitob [Muddat] ichida to'liq yakunlanadi.</p><p>2.2. Hisob-kitob yakunlangach Tomonlar bir-biriga da'voga ega emaslar (aks holda quyida ko'rsatiladi): _______________________________</p><h3>3. YAKUNIY QOIDALAR</h3><p>3.1. Ushbu kelishuv Shartnomaning ajralmas qismi bo'lib, teng yuridik kuchga ega ikki nusxada tuzildi.</p><p><strong>Tomon 1:</strong> «[Kreditor nomi]» _________________&nbsp;&nbsp; M.O'.<br><strong>Tomon 2:</strong> «[Qarzdor nomi]» _________________&nbsp;&nbsp; M.O'.</p>`,
  },
  {
    key: "blank",
    cat: "other",
